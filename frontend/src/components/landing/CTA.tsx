...
export function CTA() {
  return (
    <section className="px-6 py-12">
      <div className="relative mx-auto w-full max-w-6xl overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 via-indigo-600 to-blue-700 px-8 py-10 md:px-12 md:py-12">
        ...
        />
        <Briefcase className="pointer-events-none absolute -right-6 -top-6 h-32 w-32 text-white/10" />
        ...
        <div className="relative grid grid-cols-1 items-center gap-6 md:grid-cols-[1fr_auto]">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm text-blue-100 md:text-base">
              Browse H1B-friendly companies, get an honest ATS read on every
              posting, and tailor your resume in one click. Free to try.
            </p>
          </div>
