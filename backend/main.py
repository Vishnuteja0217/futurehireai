...
def get_demo_jobs():
    """
    Returns 10 curated H1B-sponsor jobs for the anonymous browse experience.
    
    Anyone (no auth required) can call this. Jobs are hand-picked from top
    H1B sponsors — but H1B filings counts come from OUR REAL USCIS dataset
    via check_h1b_sponsor(), so numbers stay accurate as we update the data.
    
    Update this list quarterly to keep it fresh.
    """
    # Curated demo jobs — content is hand-written, H1B data is looked up live
    demo_templates = [
        {
            ...
            "description_snippet": "Design and build large-scale distributed systems that power Amazon's retail and cloud services. Work with modern tech stacks including Java, Python, AWS.",
            "description_full": "Amazon is seeking a Software Development Engineer II to join our team. You'll design, develop, and maintain services running at massive scale. Requirements: 3+ years of professional software development, strong system design skills, experience with distributed systems and cloud infrastructure. Preferred: AWS experience, Java or Python expertise.",
            "apply_url": "https://www.amazon.jobs",
            "source": "Amazon Careers",
        },
        {
            "job_id": "demo-google-swe3",
            ...
            "salary_max": 260000,
            "salary_period": "yearly",
            "description_snippet": "Build products used by billions. Work on infrastructure, machine learning, and consumer products across Google's core teams.",
            "description_full": "Google is hiring Software Engineer III (L4). You will develop next-generation technologies that change how billions of users connect, explore, and interact with information. Requirements: BS/MS in Computer Science, 2+ years of software development experience, proficiency in one or more programming languages (C++, Java, Python, Go). Preferred: distributed systems, ML infrastructure, or full-stack development experience.",
            "apply_url": "https://careers.google.com",
            "source": "Google Careers",
        },
        {
            "job_id": "demo-microsoft-sr",
            ...
            "salary_max": 210000,
            "salary_period": "yearly",
            "description_snippet": "Join the Azure Cloud team. Build the platform that powers enterprise workloads globally. Hybrid schedule with 2-3 days in office.",
            "description_full": "Microsoft is looking for a Senior Software Engineer for our Azure team. You will design and implement cloud services at scale. Requirements: 5+ years of professional software development, expertise in C#, Python, or Go, experience with cloud platforms (Azure/AWS/GCP). Preferred: Kubernetes, distributed databases, or observability tools experience. This is a hybrid role — 2-3 days per week in Redmond office.",
            "apply_url": "https://careers.microsoft.com",
            "source": "Microsoft Careers",
        },
        {
            "job_id": "demo-nvidia-ml",
            ...
            "salary_max": 280000,
            "salary_period": "yearly",
            "description_snippet": "Work on cutting-edge deep learning research and production ML systems. GPU-accelerated computing at the core.",
            "description_full": "NVIDIA is hiring a Machine Learning Engineer. You will develop and optimize ML models for GPU-accelerated systems. Requirements: MS/PhD in Computer Science or related field, strong Python skills, PyTorch or TensorFlow expertise, understanding of deep learning fundamentals. Preferred: CUDA programming, distributed training experience, published research in top-tier venues.",
            "apply_url": "https://www.nvidia.com/careers",
        ...
        },
        {
            ...
            "salary_max": 230000,
            "salary_period": "yearly",
            "description_snippet": "Drive product decisions through data. Work on Instagram, WhatsApp, or core Facebook products.",
            "description_full": "Meta is hiring a Data Scientist for our product analytics team. You will partner with engineering and product managers to define metrics, run experiments, and generate insights. Requirements: MS/PhD in a quantitative field, 3+ years of experience in analytics or data science, expertise in SQL and Python. Preferred: A/B testing at scale, causal inference, or product analytics experience.",
            "apply_url": "https://www.metacareers.com",
            "source": "Meta Careers",
        },
        {
            "job_id": "demo-apple-ios",
            "title": "iOS Engineer",
            "company": "Apple",
            ...
            "salary_max": 235000,
            "salary_period": "yearly",
            "description_snippet": "Build the apps that ship on billions of iPhones. Swift, SwiftUI, and native iOS development.",
            "description_full": "Apple is hiring an iOS Engineer. You will develop features for one of Apple's flagship consumer apps used by hundreds of millions. Requirements: 3+ years of iOS development, expertise in Swift and Objective-C, experience with UIKit and SwiftUI. Preferred: performance optimization, Metal/Core Graphics, or accessibility experience.",
            "apply_url": "https://jobs.apple.com",
            "source": "Apple Careers",
        },
        {
            "job_id": "demo-netflix-sr-backend",
            ...
            "salary_max": 320000,
            "salary_period": "yearly",
            "description_snippet": "Scale the platform that serves 250M+ subscribers globally. High-autonomy culture, top-tier compensation.",
            "description_full": "Netflix is hiring a Senior Backend Engineer for our streaming platform team. You will design and build services handling billions of requests. Requirements: 7+ years of software engineering, deep expertise in Java or Kotlin, experience with high-scale distributed systems. Preferred: microservices architecture, chaos engineering, or content delivery experience. Fully remote within the US.",
            "apply_url": "https://jobs.netflix.com",
            "source": "Netflix Careers",
        },
        {
            "job_id": "demo-salesforce-swe",
            ...
            "salary_max": 190000,
            "salary_period": "yearly",
            "description_snippet": "Build the CRM used by 150,000+ companies. Java, Apex, Lightning platform.",
            "description_full": "Salesforce is hiring a Software Engineer for our core platform team. You will develop features on the Lightning platform used by 150,000+ enterprises. Requirements: 3+ years of software engineering, strong Java skills, RESTful API design experience. Preferred: Salesforce Apex, Aura/LWC framework, or multi-tenant SaaS experience. Hybrid role in SF office.",
            "apply_url": "https://careers.salesforce.com",
            "source": "Salesforce Careers",
        },
        {
            "job_id": "demo-linkedin-pm",
            ...
            "salary_max": 215000,
            "salary_period": "yearly",
            "description_snippet": "Shape the future of professional networking. Product Manager role on Growth or Consumer teams.",
            "description_full": "LinkedIn is hiring a Product Manager for our Consumer Growth team. You will drive product strategy for features used by 1B+ professionals. Requirements: 4+ years of product management experience, strong analytical skills, ability to work with engineering and design teams. Preferred: consumer product experience, growth or engagement metrics expertise, MBA or equivalent.",
            "apply_url": "https://careers.linkedin.com",
            "source": "LinkedIn Careers",
        },
        {
            "job_id": "demo-adobe-devops",
            ...
            "salary_max": 200000,
            "salary_period": "yearly",
            "description_snippet": "Manage infrastructure for Creative Cloud, Document Cloud, and Experience Cloud services. Kubernetes, Terraform, AWS.",
            "description_full": "Adobe is hiring a DevOps Engineer for our cloud infrastructure team. You will manage CI/CD pipelines, container orchestration, and monitoring systems. Requirements: 4+ years of DevOps or SRE experience, expertise in Kubernetes, Terraform, and AWS. Preferred: Datadog or Prometheus experience, Python scripting, security hardening background.",
            "apply_url": "https://adobe.com/careers",
            "source": "Adobe Careers",
        },
    ]
    
    # Enrich each job with REAL H1B data from our USCIS dataset
    demo_jobs = []
    for template in demo_templates:
        h1b_info = check_h1b_sponsor(template["company"])
        demo_jobs.append({
            **template,
            "h1b_sponsor": h1b_info["is_sponsor"],
            "h1b_filings_2025": h1b_info["filings_count"],
    ...
    return {
        "jobs": demo_jobs,
        "total_returned": len(demo_jobs),
        "h1b_sponsors_count": sum(1 for j in demo_jobs if j["h1b_sponsor"]),
        "query": "Curated H1B sponsor roles",
        "cached": False,
        "is_demo": True,
    }
